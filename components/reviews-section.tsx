    ...
    >
      <div className="w-full mx-auto max-w-6xl px-6 md:px-10 py-24 md:py-32">
        <div className="text-center reveal">
          ...
          <h2 className="mt-6 text-5xl md:text-6xl lg:text-7xl font-display font-normal leading-[0.95] tracking-tight text-mehlcreme">
          ...
          <a
            ...
            className="mt-7 inline-flex items-center gap-2.5 rounded-full bg-white ring-1 ring-white/20 px-5 py-2.5 hover:ring-tonwarm/60 transition-colors"
          >
